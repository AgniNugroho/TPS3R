...
function BankSampahContent() {
    ...
    const [activeTab, setActiveTab] = useState<
        "master" | "iuran" | "operasional" | "rekap"
    >("master");
        ...
        async (targetDesa = selectedDesaId) => {
            ...
            try {
                ...
                const [memberRes, wilayahRes] = await Promise.all([
                    ...
                    fetch(`/api/wilayah?${params.toString()}`, {
                        cache: "no-store",
                    }),
                ]);
    ...
    const filteredMembers = useMemo(() => {
        return members.filter((m) => {
            ...
            const matchQuery =
                ...
                (m.kode_member &&
                    m.kode_member.toLowerCase().includes(query)) ||
                (m.nomor_hp && m.nomor_hp.includes(query)) ||
                (m.alamat && m.alamat.toLowerCase().includes(query)) ||
                (m.wilayah?.dusun &&
                    m.wilayah.dusun.toLowerCase().includes(query));

            const matchWilayah =
                !wilayahFilter || m.wilayah_id === wilayahFilter;
    ...
    async function handleMemberDeleteConfirm() {
        ...
        try {
            const res = await fetch(
                `/api/member-bank-sampah?id=${deleteMember.id}`,
                {
                    method: "DELETE",
                },
            );
    ...
    async function handleDusunSubmit(e: FormEvent) {
        ...
        try {
            const payload = {
                ...
                jumlah_kk: dusunForm.jumlah_kk
                    ? parseInt(dusunForm.jumlah_kk, 10)
                    : 0,
                ...
                >
                    <button
                        ...
                        style={{
                            ...
                            cursor: "pointer",
                            background:
                                activeTab === "master" ? "#059669" : "#f1f5f9",
                            color:
                                activeTab === "master" ? "#ffffff" : "#475569",
                    ...
                    <button
                        ...
                        style={{
                            ...
                            cursor: "pointer",
                            background:
                                activeTab === "iuran" ? "#059669" : "#f1f5f9",
                            color:
                                activeTab === "iuran" ? "#ffffff" : "#475569",
                            transition: "all 0.15s ease",
                        }}
                    >
                        <Banknote size={16} />
                    ...
                    <button
                        ...
                        style={{
                            ...
                            cursor: "pointer",
                            background:
                                activeTab === "rekap" ? "#059669" : "#f1f5f9",
                            color:
                                activeTab === "rekap" ? "#ffffff" : "#475569",
                            transition: "all 0.15s ease",
                        }}
                    >
                        <Building2 size={16} />
                            ...
                            <div className="kpi-grid-clean">
                                ...
                                <div className="kpi-card-clean">
                                    ...
                                    <div className="kpi-text-clean">
                                        ...
                                        <span className="kpi-value-clean">
                                            {kpiDusun.totalKK.toLocaleString(
                                                "id-ID",
                                            )}{" "}
                                            <span className="kpi-unit-clean">
                                                KK
                                ...
                                <div className="kpi-card-clean">
                                    ...
                                    <div className="kpi-text-clean">
                                        ...
                                        <span className="kpi-value-clean">
                                            {kpiDusun.totalJiwa.toLocaleString(
                                                "id-ID",
                                            )}{" "}
                                            <span className="kpi-unit-clean">
                                                jiwa
                    ...
                    <div className="modal-backdrop-clean">
                        <div className="modal-dialog-clean modal-dialog-sm-clean">
                            ...
                            >
                                ...
                                >
                                    Catatan: Data transaksi sampah yang sudah
                                    tersimpan tetap aman di database.
                                </small>
                            </div>
                            <div
                        ...
                        <div className="modal-dialog-clean modal-dialog-sm-clean">
                            ...
                            >
                                <p style={{ margin: 0 }}>
                                    ...
                                    <strong>{deleteDusun.dusun}</strong> (
                                    {deleteDusun.kode})?
                                </p>
                            </div>
                            <div
