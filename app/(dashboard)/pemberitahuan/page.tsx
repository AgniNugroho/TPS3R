...
function PemberitahuanContent() {
    ...
    const loadPemberitahuan = useCallback(async () => {
        ...
        try {
            ...
            if (result.ok) {
                ...
                setErrorMessage(
                    result.error || "Gagal mengambil data pemberitahuan.",
                );
            }
        } catch {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (result.ok) {
                ...
                setErrorMessage(
                    result.error || "Gagal menyimpan pemberitahuan.",
                );
            }
        } catch {
    ...
    const totalAktif = pemberitahuanList.filter(
        (p) => p.status === "Aktif",
    ).length;
            ...
            <div className="page-heading">
                <div>
                    ...
                    <p className="heading-copy">
                        Kelola pengumuman operasional, libur TPS3R, dan
                        pengingat iuran bulanan yang tampil di landing page
                        publik.
                    </p>
                </div>
                <div
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <option value="Iuran & Keuangan">
                            Iuran & Keuangan
                        </option>
                        <option value="Jadwal Layanan">Jadwal Layanan</option>
                        <option value="Sosialisasi & Edukasi">
                            Sosialisasi
                        </option>
                                    ...
                                    >
                                        ...
                                        <span>
                                            ...
                                            {item.tanggal_selesai &&
                                                ` s/d ${new Date(item.tanggal_selesai).toLocaleDateString("id-ID", { dateStyle: "medium" })}`}
                                        </span>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            title={
                                                isAktif
                                                    ? "Arsipkan pemberitahuan"
                                                    : "Aktifkan kembali"
                                            }
                                        >
                                            <Archive size={13} />{" "}
                                            {isAktif ? "Arsipkan" : "Aktifkan"}
                                        </button>
                ...
                <div className="modal-backdrop-clean" onClick={closeModal}>
                    ...
                    >
                        ...
                        >
                                ...
                                <div className="form-group-clean">
                                    ...
                                    >
                                        <option value="Operasional">
                                            Operasional (Libur/Tutup)
                                        </option>
                                        <option value="Iuran & Keuangan">
                                            Iuran & Keuangan Member
                                        </option>
                                        <option value="Jadwal Layanan">
                                            Jadwal Pengangkutan
                                        </option>
                                        <option value="Sosialisasi & Edukasi">
                                            Sosialisasi & Edukasi
                                ...
                                <div className="form-group-clean">
                                    ...
                                    >
                                        ...
                                        <option value="Penting">
                                            Penting / Mendesak (Disorot Merah)
                                        </option>
                                        <option value="Info">
                                            Informasi Tambahan
                                        </option>
                            ...
                            {/* Isi Pemberitahuan */}
                            <div className="form-group-clean">
                                <label>Isi Pemberitahuan Lengkap *</label>
                                <textarea
                                    required
                                    rows={6}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {activeItem.tingkat_urgensi === "Penting"
                                        ? "PENTING"
                                        : "INFO UMUM"}
                                </span>
                                <span
                        ...
                        >
                            Kategori: <strong>{activeItem.kategori}</strong> •
                            Periode:{" "}
                            {new Date(
                                activeItem.tanggal_mulai,
                            ).toLocaleDateString("id-ID", {
                                dateStyle: "long",
                            })}
                            {activeItem.tanggal_selesai &&
                                ` s/d ${new Date(activeItem.tanggal_selesai).toLocaleDateString("id-ID", { dateStyle: "long" })}`}
                        </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <strong>&ldquo;{activeItem.judul}&rdquo;</strong>?
